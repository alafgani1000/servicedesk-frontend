...
const fields = ['name','created_at','updated_at','actions']
...
const Teams = () => {
  ...
  let editTeam = (id) => {
    axios.get(`http://localhost:4001/api/team/${id}`,{
      headers:{
        token:localStorage.getItem('shitToken')
      }
    })
  ...
  let updateTeam = (id) => {
    axios.put(`http://localhost:4001/api/team/${id}/update`,{
      'name':ename,
    },{
      headers:{
        token:localStorage.getItem('shitToken')
  ...
  let storeTeam = (id) => {
    axios.post(`http://localhost:4001/api/team/store`,{
      name:iname
    },{
      headers:{
        token:localStorage.getItem('shitToken')
  ...
  let deleteTeam = (id) => {
    axios.delete(`http://localhost:4001/api/team/${id}/delete`,{
      headers:{
        token:localStorage.getItem('shitToken')
      }
    })
