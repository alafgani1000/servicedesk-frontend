            ...
            <CRow>
              <CCol xs="12">
                <CFormGroup>
                  ...
                  <CInput
                    value={etext}
                    onChange={(event) => setEtext(event.target.value)}
                    id="etext"
                ...
                <CFormGroup>
                  ...
                  <CInput
                    value={edesc}
                    onChange={(event) => setEdesc(event.target.value)}
                    id="edesc"
            ...
            <CRow>
              <CCol xs="12">
                <CFormGroup>
                  <CLabel htmlFor="text">Text</CLabel>
                  <CInput
                    onChange={(event) => setItext(event.target.value)}
                    id="text"
                    value={itext}
                    placeholder="Enter name stage"
                    required
                ...
                <CFormGroup>
                  ...
                  <CInput
                    onChange={(event) => setIdesc(event.target.value)}
                    id="desc"
                    value={idesc}
                    placeholder="Description"
                    required
