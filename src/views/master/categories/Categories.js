            ...
            <CRow>
              <CCol xs="12">
                <CFormGroup>
                  ...
                  <CInput value={ename} onChange={event => setEname(event.target.value)} id="ename" placeholder="Enter name category" required />
                </CFormGroup>
                <CFormGroup>
                    <CLabel htmlFor="einterval">Description</CLabel>
                    <CInput value={einterval} onChange={event => setEinterval(event.target.value)} id="einterval" placeholder="Time interval" required />
                </CFormGroup>
              </CCol>
            </CRow>
          </CModalBody>
